namespace SpectrumV1.Reports.Members.Clients
{
	partial class ClientsListReport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            this.pageInfo2});
			this.BottomMargin.HeightF = 38.16666F;
			...
			// pageInfo2
			// 
			this.pageInfo2.LocationFloat = new DevExpress.Utils.PointFloat(936.0286F, 0F);
			this.pageInfo2.Name = "pageInfo2";
			this.pageInfo2.SizeF = new System.Drawing.SizeF(183.2629F, 23F);
			...
			this.label1.LocationFloat = new DevExpress.Utils.PointFloat(415.4167F, 0F);
			this.label1.Name = "label1";
			this.label1.SizeF = new System.Drawing.SizeF(288.4581F, 34.16667F);
			this.label1.StyleName = "Title";
			this.label1.StylePriority.UseFont = false;
			this.label1.StylePriority.UseTextAlignment = false;
			this.label1.Text = "Clients List Report";
            ...
            this.tableRow1});
			this.table1.SizeF = new System.Drawing.SizeF(1119.291F, 28F);
			...
			this.tableCell1.Text = "Client Name";
			this.tableCell1.Weight = 0.07801157934042656D;
			// 
			// tableCell2
			// 
			...
			this.tableCell2.Text = "Contact Person";
			this.tableCell2.Weight = 0.095942043792311124D;
			// 
			// tableCell3
			// 
			...
			this.tableCell3.Weight = 0.0582223022101434D;
			// 
			// tableCell4
			// 
			...
			this.tableCell4.Weight = 0.043378987580655219D;
			// 
			// tableCell5
			// 
			...
			this.tableCell5.Weight = 0.099034624677363389D;
			// 
			// tableCell8
			// 
			...
			this.tableCell8.Text = "Fax Number";
			this.tableCell8.Weight = 0.07801157934042656D;
			// 
			// tableCell9
			// 
			...
			this.tableCell9.Text = "Website";
			this.tableCell9.Weight = 0.056358058469088909D;
			// 
			// tableCell10
			// 
			...
			this.tableCell10.Text = "Po Box";
			this.tableCell10.Weight = 0.052026262572516496D;
			// 
			// tableCell11
			// 
			...
			this.tableCell11.Weight = 0.051390352039907133D;
			// 
			// tableCell12
			// 
			...
			this.tableCell12.Text = "Activity";
			this.tableCell12.Weight = 0.053890506313570979D;
			// 
			// tableCell13
			// 
			...
			this.tableCell13.Text = "Country";
			this.tableCell13.Weight = 0.056347188472671839D;
			// 
			// tableCell14
			// 
			...
			this.tableCell14.Text = "City";
			this.tableCell14.Weight = 0.034709972595959794D;
			// 
			// table2
			// 
            ...
            this.tableRow2});
			this.table2.SizeF = new System.Drawing.SizeF(1119.291F, 25F);
			// 
			// tableRow2
			// 
			...
			this.tableCell16.Weight = 0.07801157934042656D;
			// 
			// tableCell17
			// 
			...
			this.tableCell17.Weight = 0.095942043792311124D;
			// 
			// tableCell18
			// 
			...
			this.tableCell18.Weight = 0.0582223022101434D;
			// 
			// tableCell19
			// 
			...
			this.tableCell19.Weight = 0.043378987580655219D;
			// 
			// tableCell20
			// 
			this.tableCell20.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[PhoneNumber1] + \'|\' + [PhoneNumber2] + \'|\' + [PhoneNumber3]\n")});
			this.tableCell20.Name = "tableCell20";
			this.tableCell20.StyleName = "DetailData1";
			this.tableCell20.Weight = 0.099034624677363389D;
			// 
			// tableCell23
			// 
			...
			this.tableCell23.Weight = 0.07801157934042656D;
			// 
			// tableCell24
			// 
			...
			this.tableCell24.Weight = 0.056358058469088909D;
			// 
			// tableCell25
			// 
			...
			this.tableCell25.Weight = 0.052026262572516496D;
			// 
			// tableCell26
			// 
			...
			this.tableCell26.Weight = 0.051390352039907133D;
			// 
			// tableCell27
			// 
			...
			this.tableCell27.Weight = 0.053890506313570979D;
			// 
			// tableCell28
			// 
			...
			this.tableCell28.Weight = 0.056347188472671839D;
			// 
			// tableCell29
			// 
			...
			this.tableCell29.Weight = 0.034709972595959794D;
			// 
			// objectDataSource1
			// 
			this.objectDataSource1.DataSource = typeof(SpectrumV1.Models.Members.Clients.ClientModel);
			...
			// xrPageInfo2
			// 
			this.xrPageInfo2.LocationFloat = new DevExpress.Utils.PointFloat(755.261F, 37F);
			this.xrPageInfo2.Name = "xrPageInfo2";
			this.xrPageInfo2.PageInfo = DevExpress.XtraPrinting.PageInfo.DateTime;
			this.xrPageInfo2.SizeF = new System.Drawing.SizeF(364.0305F, 23F);
            ...
            this.xrTableRow1});
			this.xrTable1.SizeF = new System.Drawing.SizeF(1119.291F, 25F);
			// 
			// xrTableRow1
			// 
			...
			this.xrTableCell13.Font = new DevExpress.Drawing.DXFont("Arial", 8F, DevExpress.Drawing.DXFontStyle.Italic);
			this.xrTableCell13.Name = "xrTableCell13";
			this.xrTableCell13.StyleName = "DetailData1";
			this.xrTableCell13.StylePriority.UseFont = false;
			this.xrTableCell13.Weight = 0.0446073168535477D;
			// 
			// ClientsListReport
			// 
			...
			this.Landscape = true;
			this.Margins = new DevExpress.Drawing.DXMargins(23F, 27F, 12.5F, 38.16666F);
