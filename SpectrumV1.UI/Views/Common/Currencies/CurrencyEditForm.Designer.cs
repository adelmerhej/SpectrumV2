namespace SpectrumV1.Views.Common.Currencies
{
	partial class CurrencyEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			// chkIsDefault
			// 
			this.chkIsDefault.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsCurrency, "IsDefault", true));
			...
			// bsCurrency
			// 
			this.bsCurrency.DataSource = typeof(SpectrumV1.Models.Common.Currencies.CurrencyModel);
			// 
			// CurrencyEditForm
			// 
