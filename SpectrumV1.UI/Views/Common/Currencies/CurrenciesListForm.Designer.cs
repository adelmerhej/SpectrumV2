namespace SpectrumV1.Views.Common.Currencies
{
	partial class CurrenciesListForm
	{
		...
		private void InitializeComponent()
		{
			...
			// bsCurrencies
			// 
			this.bsCurrencies.DataSource = typeof(SpectrumV1.Models.Common.Currencies.CurrencyModel);
			// 
			// bsExchangeCurrencies
			// 
			this.bsExchangeCurrencies.DataSource = typeof(SpectrumV1.Models.Common.Currencies.CurrencyExchangeModel);
			// 
			// colCurrencyName
			// 
			...
			this.colHighValue.MinWidth = 25;
			this.colHighValue.Name = "colHighValue";
			this.colHighValue.Visible = true;
			this.colHighValue.VisibleIndex = 3;
			this.colHighValue.Width = 132;
			// 
			// col_id1
			// 
