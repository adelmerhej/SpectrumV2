namespace SpectrumV1.Views.Common.Departments
{
	partial class DepartmentsListForm
	{
		...
		private void InitializeComponent()
		{
			...
			// bsDepartments
			// 
			this.bsDepartments.DataSource = typeof(SpectrumV1.Models.Common.Departments.DepartmentModel);
			// 
			// gvDepartments
			// 
			...
			this.gvDepartments.RowCellStyle += new DevExpress.XtraGrid.Views.Grid.RowCellStyleEventHandler(this.gvDepartments_RowCellStyle);
			this.gvDepartments.DoubleClick += new System.EventHandler(this.gvDepartments_DoubleClick);
			// 
			// col_id
			// 
