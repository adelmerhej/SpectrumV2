namespace SpectrumV1.Views.Common.Departments
{
	partial class DepartmentEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			// chkIsDefault
			// 
			this.chkIsDefault.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsDepartment, "IsDefault", true));
			...
			// chkActive
			// 
			this.chkActive.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsDepartment, "Active", true));
			...
			// txtNotes
			// 
			this.txtNotes.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsDepartment, "Notes", true));
			...
			// txtName
			// 
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsDepartment, "DepartmentName", true));
			...
			// bsDepartment
			// 
			this.bsDepartment.DataSource = typeof(SpectrumV1.Models.Common.Departments.DepartmentModel);
			// 
			// DepartmentEditForm
			// 
