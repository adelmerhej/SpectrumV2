namespace SpectrumV1.Views.Common.Areas
{
	partial class LocationEditForm
	{
		...
		private void InitializeComponent()
		{
			...
			// bsLocation
			// 
			this.bsLocation.DataSource = typeof(SpectrumV1.Models.Common.Areas.LocationModel);
			// 
			// mainLayout
			// 
			...
			// txtCode
			// 
			this.txtCode.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsLocation, "LocationCode", true));
