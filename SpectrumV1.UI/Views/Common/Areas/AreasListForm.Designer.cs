namespace SpectrumV1.Views.Common.Areas
{
	partial class AreasListForm
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AreasListForm));
			this.rcAreasList = new DevExpress.XtraBars.Ribbon.RibbonControl();
			...
			this.rpAreasList = new DevExpress.XtraBars.Ribbon.RibbonPage();
			...
			((System.ComponentModel.ISupportInitialize)(this.rcAreasList)).BeginInit();
			...
			// rcAreasList
			// 
			this.rcAreasList.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(35, 39, 35, 39);
			this.rcAreasList.ExpandCollapseItem.Id = 0;
			this.rcAreasList.Items.AddRange(new DevExpress.XtraBars.BarItem[] {
            this.rcAreasList.ExpandCollapseItem,
            this.btnNew,
            this.btnDelete,
            this.btnEdit,
            this.btnPrint,
			...
			this.rcAreasList.Location = new System.Drawing.Point(0, 0);
			this.rcAreasList.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			this.rcAreasList.MaxItemId = 42;
			this.rcAreasList.MdiMergeStyle = DevExpress.XtraBars.Ribbon.RibbonMdiMergeStyle.Always;
			this.rcAreasList.Name = "rcAreasList";
			this.rcAreasList.OptionsMenuMinWidth = 385;
			this.rcAreasList.Pages.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPage[] {
            this.rpAreasList,
            this.rpViewSettings});
			this.rcAreasList.Size = new System.Drawing.Size(1385, 193);
			this.rcAreasList.StatusBar = this.ribbonStatusBar1;
			// 
			// btnNew
			// 
			...
			// rpAreasList
			// 
			this.rpAreasList.Groups.AddRange(new DevExpress.XtraBars.Ribbon.RibbonPageGroup[] {
            this.ribbonPageGroup1,
            this.ribbonPageGroup6,
            this.ribbonPageGroup8,
            this.ribbonPageGroup11});
			this.rpAreasList.Name = "rpAreasList";
			this.rpAreasList.Text = "AREAS";
			// 
			// ribbonPageGroup1
			// 
			...
			this.ribbonStatusBar1.Ribbon = this.rcAreasList;
			this.ribbonStatusBar1.Size = new System.Drawing.Size(1385, 30);
			// 
			// mainLayout
			// 
			this.mainLayout.Controls.Add(this.gcAreas);
			this.mainLayout.Dock = System.Windows.Forms.DockStyle.Fill;
			this.mainLayout.Location = new System.Drawing.Point(0, 193);
			this.mainLayout.Name = "mainLayout";
			this.mainLayout.Root = this.Root;
			this.mainLayout.Size = new System.Drawing.Size(1385, 564);
			this.mainLayout.TabIndex = 5;
			this.mainLayout.Text = "layoutControl1";
			// 
			// gcAreas
			// 
			this.gcAreas.DataSource = this.bsAreas;
			...
			this.gvAreas.OptionsBehavior.AllowFixedGroups = DevExpress.Utils.DefaultBoolean.True;
			this.gvAreas.OptionsBehavior.AutoExpandAllGroups = true;
			this.gvAreas.OptionsBehavior.Editable = false;
			this.gvAreas.OptionsBehavior.ReadOnly = true;
			this.gvAreas.OptionsFind.AlwaysVisible = true;
			this.gvAreas.OptionsView.ColumnAutoWidth = false;
			this.gvAreas.OptionsView.ShowGroupedColumns = true;
			this.gvAreas.OptionsView.ShowGroupPanel = false;
			this.gvAreas.RowCellStyle += new DevExpress.XtraGrid.Views.Grid.RowCellStyleEventHandler(this.gvAreas_RowCellStyle);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(1385, 564);
			...
			this.colAreaCode.VisibleIndex = 0;
			...
			this.Controls.Add(this.rcAreasList);
			this.Name = "AreasListForm";
			this.Ribbon = this.rcAreasList;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.StatusBar = this.ribbonStatusBar1;
			this.Text = "Areas List";
			((System.ComponentModel.ISupportInitialize)(this.rcAreasList)).EndInit();
		...
		public DevExpress.XtraBars.Ribbon.RibbonControl rcAreasList;
		...
		private DevExpress.XtraBars.Ribbon.RibbonPage rpAreasList;
