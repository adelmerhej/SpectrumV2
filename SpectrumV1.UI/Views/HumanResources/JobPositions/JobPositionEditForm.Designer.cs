namespace SpectrumV1.Views.HumanResources.JobPositions
{
	partial class JobPositionEditForm
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.bsJobPosition = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.bsJobPosition)).BeginInit();
			this.SuspendLayout();
			// 
			// mainLayout
			// 
			...
			// chkIsDefault
			// 
			this.chkIsDefault.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsJobPosition, "IsDefault", true));
			...
			// chkActive
			// 
			this.chkActive.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsJobPosition, "Active", true));
			...
			// txtNotes
			// 
			this.txtNotes.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsJobPosition, "Notes", true));
			...
			// txtName
			// 
			this.txtName.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.bsJobPosition, "PositionName", true));
			...
			this.grpInfo.Text = "Job Position Info";
			// 
			// lblName
			// 
			...
			// bsJobPosition
			// 
			this.bsJobPosition.DataSource = typeof(SpectrumV1.Models.HumanResources.JobPositions.JobPositionModel);
			// 
			// JobPositionEditForm
			// 
			...
			this.Name = "JobPositionEditForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Edit Job Position";
			...
			((System.ComponentModel.ISupportInitialize)(this.bsJobPosition)).EndInit();
		...
		private System.Windows.Forms.BindingSource bsJobPosition;
	}
}