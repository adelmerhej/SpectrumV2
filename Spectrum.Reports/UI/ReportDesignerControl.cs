...
{
	/// <summary>
	/// Main report builder/editor control that hosts a <see cref="SpreadsheetControl"/>
	/// with the full DevExpress spreadsheet ribbon (Home, Insert, Page Layout, Formulas,
	/// Data, Review, View), a formula bar, a status bar, a field list panel, and a summary panel.
	/// A custom "Report Builder" tab provides domain-specific operations:
	/// add/remove records, field insertion (value, horizontal label+value, vertical label+value),
	/// export, and A4 layout.
	/// </summary>
